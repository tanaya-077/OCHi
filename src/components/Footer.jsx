...
const Footer = () => {
  return (
    <div data-scroll data-section-scroll data-scroll-speed="-.3"
    className="w-full h-screen text-black p-15 flex gap-5 font-['Founders Grotesk Medium']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[8.8vw] font-bold uppercase -mb-10 tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[8.8vw] font-bold uppercase leading-none -mb-10 tracking-tighter">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <div className="heading">
          <h1 className="text-[6vw] font-bold uppercase -mb-10 -tracking-wide">
            presentaions
          </h1>
          <div className="details font-['Neue Montreal'] mt-10 ">
            <a className="text-xl font-light block" href="">
              Intsagram
            </a>
            <a className="text-xl font-light block" href="">
              Facebook
